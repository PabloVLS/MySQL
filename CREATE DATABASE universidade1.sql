...
/*2*/
select nome, cpf, data_nascimento from aluno where data_nascimento > 1990-01-01;
/*5*/
select id_aluno, nota from matricula  join matricula_disciplina on matricula.id_matricula=matricula_disciplina.id_matricula 
...
alter table matricula_disciplina Drop foreign key matricula_disciplina_ibfk_2;
	alter table matricula_disciplina
		add constraint id_disciplina foreign key (id_disciplina)
